...
export const RELAYER_URL = process.env.REACT_APP_RELAYER_URL || 'https://api.0x.org/sra/v3';
export const RELAYER_WS_URL = process.env.REACT_APP_RELAYER_WS_URL || 'wss://api.0x.org/sra/v3';
...
export const UI_GENERAL_TITLE = 'ERC20 Exchange';
